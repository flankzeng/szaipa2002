...
- **Bootstrap 分页退役试点（2026-07-22）**：NewVip/PublicationList/NewNews 不再加载 143,947B Bootstrap CSS，改用带版本的 2,335B 兼容基线；每个冷页面原始体积少 141,612B，前后计算样式/几何一致，320–1440 共 26 个断点检查全过。其余页面默认仍加载 Bootstrap。总测试 218→219。详见 `docs/updates/2026-07-22-bootstrap-optout-pilot.md`。

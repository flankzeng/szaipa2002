...
The current verified baseline is a clean .NET build, 223 passing tests, and a successful npm build. A release artifact is not production-ready merely because it builds: the external runtime contracts below must also be satisfied.
